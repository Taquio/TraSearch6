...
public class PlaceAutocompleteAdapter
    ...
    public PlaceAutocompleteAdapter(MapsActivity context, GoogleApiClient mApiClient,
                                    LatLngBounds latLngBounds, AutocompleteFilter filter) {
        super(context, android.R.layout.simple_expandable_list_item_1, android.R.id.text1);
        mGoogleApiClient = mApiClient;
